...
urlpatterns = [
    ...
    path('no-personal-information', TemplateView.as_view(template_name='privalytics/no_private_information.html'),
    ...
    path('data-collection', TemplateView.as_view(template_name='privalytics/data_collection.html'),
